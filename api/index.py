...
wwbhook_handler = WebhookHandler('72fb67decf0b6155beac93cfe8bd50bb')
...
def callback():
    ...
    # handle webhook body
    try:
        wwbhook_handler.handle(body, signature)
...
@wwbhook_handler.add(MessageEvent, message=TextMessage)
